...
export default () => (<div>
    <h2 className="PageHeader">Apply To Sell Art</h2>
        <div className="historytextcolour"><hr /> 
            ...
            <p className="PageHeader">ESP Gallery is here to help show your work to the world. We have years of experiance and are dedicated to showcaseing artist’s work. Your art should be easily accessable by everyone.</p>
